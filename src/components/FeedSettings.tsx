...
import { Checkbox, CheckboxGroup, Description, Label, Tooltip, toast } from "@heroui/react";
  ...
  return (
    ...
    <div className={`${contentColumn} py-8 pb-24 md:pb-28`}>
      ...
      <div className="max-w-2xl mx-auto">
        {/* The heading is deliberately quieter than the serif feed names below
            it: it names the section, and a heading that outweighed the things
            it introduces would read as another feed. */}
        <div className="flex items-center gap-2 mb-5">
          ...
          {/* What switching a source off actually does, kept behind the icon
              ...
              `break-normal` undoes the tooltip's default `break-all`, which is
              meant for URLs and would hyphenate this mid-word. */}
          <Tooltip delay={200}>
            <Tooltip.Trigger
